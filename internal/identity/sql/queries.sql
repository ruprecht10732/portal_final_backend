...
VALUES (
  ...
  COALESCE(sqlc.narg('photo_analysis_ocr_assist_enabled')::boolean, false),
  COALESCE(sqlc.narg('photo_analysis_ocr_assist_service_types')::text[], '{}'::text[]),
  COALESCE(sqlc.narg('photo_analysis_lens_correction_enabled')::boolean, false),
  COALESCE(sqlc.narg('photo_analysis_lens_correction_service_types')::text[], '{}'::text[]),
  COALESCE(sqlc.narg('photo_analysis_perspective_normalization_enabled')::boolean, false),
...
ON CONFLICT (organization_id) DO UPDATE SET
  ...
  photo_analysis_ocr_assist_enabled = COALESCE(sqlc.narg('photo_analysis_ocr_assist_enabled')::boolean, RAC_organization_settings.photo_analysis_ocr_assist_enabled),
  photo_analysis_ocr_assist_service_types = COALESCE(sqlc.narg('photo_analysis_ocr_assist_service_types')::text[], RAC_organization_settings.photo_analysis_ocr_assist_service_types),
  photo_analysis_lens_correction_enabled = COALESCE(sqlc.narg('photo_analysis_lens_correction_enabled')::boolean, RAC_organization_settings.photo_analysis_lens_correction_enabled),
  photo_analysis_lens_correction_service_types = COALESCE(sqlc.narg('photo_analysis_lens_correction_service_types')::text[], RAC_organization_settings.photo_analysis_lens_correction_service_types),
  photo_analysis_perspective_normalization_enabled = COALESCE(sqlc.narg('photo_analysis_perspective_normalization_enabled')::boolean, RAC_organization_settings.photo_analysis_perspective_normalization_enabled),
