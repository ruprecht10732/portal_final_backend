...
func (h *Handler) GetOrganizationSettings(c *gin.Context) {
	...
	httpkit.OK(c, transport.OrganizationSettingsResponse{
		...
		AIAdaptiveReasoningEnabled:                        settings.AIAdaptiveReasoningEnabled,
		AIExperienceMemoryEnabled:                         settings.AIExperienceMemoryEnabled,
		AICouncilEnabled:                                  settings.AICouncilEnabled,
...
func (h *Handler) UpdateOrganizationSettings(c *gin.Context) {
	...
	settings, err := h.svc.UpdateOrganizationSettings(c.Request.Context(), *tenantID, repository.OrganizationSettingsUpdate{
		...
		AIConfidenceGateEnabled:                           req.AIConfidenceGateEnabled,
		AIAdaptiveReasoningEnabled:                        req.AIAdaptiveReasoningEnabled,
		AIExperienceMemoryEnabled:                         req.AIExperienceMemoryEnabled,
		AICouncilEnabled:                                  req.AICouncilEnabled,
		AICouncilConsensusMode:                            req.AICouncilConsensusMode,
		CatalogGapThreshold:                               req.CatalogGapThreshold,
		CatalogGapLookbackDays:                            req.CatalogGapLookbackDays,
		PhotoAnalysisPreprocessingEnabled:                 req.PhotoAnalysisPreprocessingEnabled,
		PhotoAnalysisOCRAssistEnabled:                     req.PhotoAnalysisOCRAssistEnabled,
		PhotoAnalysisOCRAssistServiceTypes:                req.PhotoAnalysisOCRAssistServiceTypes,
		PhotoAnalysisLensCorrectionEnabled:                req.PhotoAnalysisLensCorrectionEnabled,
		PhotoAnalysisLensCorrectionServiceTypes:           req.PhotoAnalysisLensCorrectionServiceTypes,
