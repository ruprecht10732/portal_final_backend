...
type Querier interface {
	...
	ListQuoteAttachmentsByQuoteIDs(ctx context.Context, arg ListQuoteAttachmentsByQuoteIDsParams) ([]RacQuoteAttachment, error)
	...
	ListQuoteURLsByQuoteIDs(ctx context.Context, arg ListQuoteURLsByQuoteIDsParams) ([]RacQuoteUrl, error)
