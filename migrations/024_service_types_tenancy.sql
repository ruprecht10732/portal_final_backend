...
CREATE UNIQUE INDEX IF NOT EXISTS idx_service_types_org_name ON service_types(organization_id, name);
CREATE UNIQUE INDEX IF NOT EXISTS idx_service_types_org_slug ON service_types(organization_id, slug);
CREATE INDEX IF NOT EXISTS idx_service_types_org ON service_types(organization_id);
