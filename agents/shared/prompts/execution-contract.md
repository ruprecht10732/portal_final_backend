...
8. Output tool calls only during execution. After the final mandatory tool succeeds, output a single short text line to signal completion. No other free text is allowed.
